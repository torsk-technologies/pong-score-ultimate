...
class RulesStrings {
    ...
    val point: String = """
        ...
        2.10.1.14 if both players or pairs are in a wheelchair due to a physical disability and
          ...
          2.10.1.14.1 
          his or her opponent does not maintain a minimum 
          contact with the seat or cushion(s), with the back of the 
          thigh, when the ball is struck;
       
          2.10.1.14.2 
          his or her opponent touches the table with either hand 
          before striking the ball;
       
          2.10.1.14.3 
          his or her opponent’s footrest or foot touches the floor 
          during play.
    """.trimIndent()
